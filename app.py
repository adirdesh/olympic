...
try:
    ...
    if user_menu == 'Medal Tally':
        ...
        if not medal_tally.empty:
            ...
            st.warning("No medals found for the selected criteria")

except Exception as e:
    st.error(f"An error occurred: {str(e)}")
    st.write("Please check if your data files are in the correct location and format.")
...
if user_menu == 'Athlete Wise Analysis':
    ...
    fig, ax = plt.subplots(figsize=(14, 10))  # Adjusted the figure size here
    sns.scatterplot(
        x='Weight',
        y='Height',
        hue='Medal',
